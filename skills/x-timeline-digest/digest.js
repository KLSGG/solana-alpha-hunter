...
function runBird(args) {
  try {
    const AUTH = `--auth-token "97ad067a9c5087771ff28fdb18318c4d7ef3d915" --ct0 "6e27203a31e3eea1d143cc0ae97ff2e66e2328d943ae5c3955df574ebada3ebc231dfdf03f14dadb8e6dac682342d56a6b74a15dda76935e6e6780e10c78cc25ea01646ba4e0868f3c68f07e61506543"`;
    // Suppress stderr to keep logs clean, or capture it if debugging needed
    const output = execSync(`bird ${args} ${AUTH}`, { encoding: 'utf8', maxBuffer: 10 * 1024 * 1024 });
